...
hex1 = Label(colors, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
hex1.place(x=60, y=15)
hex2 = Label(colors, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
hex2.place(x=60, y=65)
hex3 = Label(colors, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
hex3.place(x=60, y=115)
hex4 = Label(colors, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
hex4.place(x=60, y=165)
hex5 = Label(colors, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
...
hex6 = Label(colors2, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
hex6.place(x=60, y=15)
hex7 = Label(colors2, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
hex7.place(x=60, y=65)
hex8 = Label(colors2, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
hex8.place(x=60, y=115)
hex9 = Label(colors2, text='No color', fg='#000',
             font='arial 12 bold', bg='white')
hex9.place(x=60, y=165)
hex10 = Label(colors2, text='No color', fg='#000',
              font='arial 12 bold', bg='white')
...
Button(selectimage, text="Find Colors", width=12,
       height=1, font='arial 14 bold',command=FindColor).place(x=176, y=300)
